...
<!-- Body -->
<section class="home-banner-area overlay-bg" id="home">
	<div class="overlay overlay-bg"></div>
	<div class="container">
		<div class="row align-items-end justify-content-center" style="height: 600px;">
			<div class="banner-content col-lg-12 col-md-12">
				<h1>Cari kosan? Kosanku Aja!</h1>
...
<section class="kosan-area section-gap relative" id="kosan-list">
	<div class="container">
		<div class="row d-flex justify-content-center">
			<div class="col-md-10 header-text">
				<h1>Temukan kosan idamanmu sekarang juga!</h1>
				<p>
					Kosanku website penyedia layanan pencarian kos yang seusai dengan kebutuhan anda.
				</p>
			</div>
		</div>
		<div class="row">
